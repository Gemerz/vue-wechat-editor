                        ...
                        <div class='editor-item' v-for="preview in previews | orderBy 'key'">
                            ...
                            <div v-else class="list-coantainer">
                                <div class='list'>
                                    ...
                                    <span class='thumbnail'><img class='cover-img' :src="preview.data.cover"/></span>
                                    <div class='editor-item-edit' @click="editPreview(preview.key)">
                                        <a @click="previewCard(preview.key)">
...
<div v-if="editedPreview !== null" class="editpreviewcard">
    <mdl-dialog title="預覽" display-on="infoMessage" cancellable>
        <mdl-card class="demo-card-welcome" :title="editedPreview.data.title ? editedPreview.data.title:' '" :supporting-text="editedPreview.data.content?editedPreview.data.content:' '" :media="editedPreview.data.cover"></mdl-card>
    </mdl-dialog>
</div>
